...
const saveTheme = () => {
    const index = themeOptions.value.findIndex(x => x.label === themeName.value);
    if (index !== -1) {
  ...
  >
    <el-form :model="settingForm" label-width="120px">
      <el-form-item label="语言">
        <el-select v-model="settingForm.lang" placeholder="请选择主题">
          <el-option
      ...
      <el-form-item label="主题">
        <el-select v-model="settingForm.theme" placeholder="请选择主题">
          <el-option
      ...
      <el-form-item label="默认颜色">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-button :color="settingForm.color.default"></el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="主要颜色">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-button :color="settingForm.color.primary"></el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="成功颜色">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-button :color="settingForm.color.success"></el-button>
          </el-col>
        </el-row>
      </el-form-item>
      ...
      <el-form-item label="警告颜色">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-button :color="settingForm.color.warning"></el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="危险颜色">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-button :color="settingForm.color.danger"></el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="新主题名称" v-if="isShow">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-input
              v-model="themeName"
          ...
          <el-col :span="12">
            <el-button type="primary" @click="saveTheme">保存到主题</el-button>
          </el-col>
        </el-row>
      </el-form-item>
      <el-form-item label="皮肤">
        <el-select v-model="settingForm.bgColor" placeholder="请选择皮肤">
          <el-option
